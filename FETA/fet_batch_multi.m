function fet_batch_multi(actN,maxN,hPB,inFile,trackingDir,outDir,normFunc,res,IOD,descFunc,patchSize,saveNormVideo,saveNormLandmarks,saveVideoLandmarks)
...
for i = 1:nItems
    ...
    fitOld = fitOld.fit;
    fitOldRange = cell2mat({fit(:).frame}');
