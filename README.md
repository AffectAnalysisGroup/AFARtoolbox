# Update :new:
### AFARtoolbox is still functional, however, we recommend using our new, faster, dependency-free:exclamation: GUI version-[PyAFAR](https://affectanalysisgroup.github.io/PyAFAR/). Thank you for using AFARtoolbox, we hope to hear from you about your experience with [PyAFAR](https://affectanalysisgroup.github.io/PyAFAR/).
